...
const Waakye = () => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <Text style={styles.title}>Waakye</Text>
        <Text style={styles.description}>Waakye is a hearty and colorful Ghanaian dish made from rice and beans cooked together, traditionally tinted with dried millet leaves for a slight herbal flavor and a signature brownish hue. It's often served with an array of sides like gari (grated cassava), spaghetti, fried plantains, boiled eggs, and various meats. Waakye is a full meal that captures the bold and communal spirit of Ghanaian cuisine.</Text>
      </View>
    </View>
  )
}
